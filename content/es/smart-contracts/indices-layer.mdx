...
description: "Capa de índices (Dominio y Lógica de Negocio) Ubicación: Componentes clave: - : Contrato de índice central que gestiona componentes y ponderaciones. - :…"
position: 5
---

...
description: 'Componentes clave: Contrato de índice central que gestiona componentes y ponderaciones. Fábrica para desplegar instancias de Index. Lista blanca de tokens aprobados.'
position: 5
---

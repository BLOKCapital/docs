...
description: "Descripción general del sistema Este repositorio implementa un protocolo de gestión de activos on-chain construido alrededor de un controlador Diamond…"
position: 1
---
![Visión general del sistema](/img/Frame%2021.jpg)

...
description: Este repositorio implementa un protocolo de gestión de activos on-chain construido alrededor de un controlador Diamond (EIP-2535) llamado el Jardín (Garden).
position: 1
---
![Visión general del sistema](/img/Frame-21.jpg)

...
description: 'El poder de Diamond viene con una gran restricción: todas las facetas comparten el almacenamiento. Para gestionar eso de forma segura, este repositorio utiliza librerías de almacenamiento.'
position: 6
---

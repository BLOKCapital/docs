...
description: 'Archivos clave del registro de facetas: FacetRegistry.sol gestiona el registro de facetas y el seguimiento de versiones; IFacetRegistry.sol es la interfaz pública.'
position: 4
---

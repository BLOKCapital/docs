---
title: Glosario
description: Arquitectura Central (Patron Diamond / EIP-2535) · Garden y Factory · Indice y Rebalanceo · Gobernanza y Estado del Protocolo · DEX y Liquidez
position: 1
---
...
| Rebalance Interval (Intervalo de Rebalanceo) | Tiempo minimo (24 horas) entre rebalanceos consecutivos. |
| Intent Interval (Intervalo de Intencion) | Tiempo minimo (11 minutos) entre creaciones de intenciones de rebalanceo. Se mantiene mayor que la expiracion de 10 minutos para que una intencion vigente no pueda sobrescribirse. |
| Swap Call (Llamada de Intercambio) | Instruccion individual de intercambio proporcionada por el llamante, que contiene selector, datos codificados, token de salida, salida minima y un deadline. |

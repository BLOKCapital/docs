...
description: Regístrese con Google. Cree su cuenta de billetera inteligente (SWA). Esta es la cuenta que guardará sus activos e interactuará con el protocolo.
position: 2
---
![Flujo del recorrido del usuario](/img/Userflow.png)
...
Las secciones anteriores describen el recorrido en orden. Las páginas siguientes desglosan cada parte en los pasos reales dentro de la aplicación, incluido lo que ocurre cuando algo falla.

- [Inicio de Sesión y Panel](/es/concepts/user-journey/signing-in) cubre ambos métodos de inicio de sesión, qué carga el panel y cómo terminan las sesiones.
- [Crear y Financiar Jardines](/es/concepts/user-journey/gardens) cubre la creación de un Jardín de rendimiento o de Index, la pantalla de detalles y cómo ingresar activos.
- [Trading y Préstamos](/es/concepts/user-journey/trading-and-lending) cubre swaps, préstamos y el retiro de USDC.
- [Jardines de Index](/es/concepts/user-journey/index-gardens) cubre explorar índices, conectar, rebalancear y desconectar.
- [Rendimiento, Gobernanza y Ajustes](/es/concepts/user-journey/performance-and-governance) cubre los gráficos de rendimiento, las votaciones y la sección de cuenta.
- [Estados de Transacción](/es/concepts/user-journey/transaction-states) cubre la secuencia de estados que comparten todas las acciones on-chain.

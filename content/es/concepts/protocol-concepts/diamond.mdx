...
description: "Descripción general de la arquitectura Diamond La arquitectura Diamond es un sistema modular de contratos inteligentes diseñado para protocolos de larga…"
position: 1
---
## Descripción general de la arquitectura Diamond

![Arquitectura del proxy Diamond](/img/Diamond_proxy.png)

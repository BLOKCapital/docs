...
description: La arquitectura Diamond es un sistema modular de contratos inteligentes diseñado para protocolos de larga duración y en constante evolución.
position: 1
---

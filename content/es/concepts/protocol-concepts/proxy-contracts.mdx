...
description: "Explicación de los Contratos Proxy Un contrato proxy es una forma de actualizar un sistema de contratos inteligentes sin cambiar la dirección con la que…"
position: 2
---
![Patrón de contrato proxy](/img/Frame%2025.jpg)

...
description: Un contrato proxy es una forma de actualizar un sistema de contratos inteligentes sin cambiar la dirección con la que interactúan los usuarios.
position: 2
---

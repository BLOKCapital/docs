...
description: "Visión General En este proyecto utilizamos el patrón \"Diamond\" (EIP-2535) para componer contratos modulares. Un Diamond es un proxy que delega llamadas a…"
position: 3
---
### Visión General

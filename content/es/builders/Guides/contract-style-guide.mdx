---
title: Guía de estilo para contratos inteligentes
description: 'Nuestro protocolo utiliza una arquitectura modular de diamante/faceta, donde cada faceta encapsula un dominio específico (p. ej., intercambios Uniswap, creación de gardens, control de acceso).'
---
...
Siga la guía oficial de Solidity para más detalles: [guía de estilo oficial de Solidity](https://docs.soliditylang.org/en/latest/style-guide.html#order-of-layout)

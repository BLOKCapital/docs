---
title: Cut
description: 'Este módulo gestiona las actualizaciones de estado dentro del Diamond, pero aplica el estricto modelo de seguridad "Registry-First" de Blok Capital.'
position: 1
---

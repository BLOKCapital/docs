---
title: Upgrade
description: "Como está bloqueado en las Base Facets, el Módulo de Upgrade es la única forma autorizada de modificar la lógica de un Garden. Se basa en una…"
position: 4
---

---
title: Facet.sol
description: actúa como el contrato base para todos los módulos de lógica del Garden. Define las reglas centrales de control de acceso que sigue cada módulo.
position: 1
---

---
title: Facet.sol
description: "Capa de Acceso: - actúa como el contrato base para todos los módulos de lógica del Garden. - Define las reglas centrales de control de acceso que sigue…"
position: 1
---

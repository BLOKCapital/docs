...
description: Estos archivos contienen la lógica de negocio principal para el rebalanceo de carteras. El proceso se divide en dos transacciones distintas para garantizar la seguridad.
position: 3
---
...
2. **`_rebalance(SwapStep[])`:** Ejecuta las operaciones reales según las instrucciones proporcionadas por el llamante.

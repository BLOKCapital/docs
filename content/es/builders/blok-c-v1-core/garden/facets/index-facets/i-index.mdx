---
title: IIndex.sol
description: Esta interfaz define las estructuras de datos esenciales que se intercambian entre el Centralized Relayer Engine (CRE) off-chain y el protocolo on-chain.
position: 2
---

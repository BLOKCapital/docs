---
title: Jardines & Diamonds
description: "La arquitectura de Diamonds & Gardens En BLOK Capital, nuestra arquitectura principal para los smart contracts se basa en el patrón proxy Diamond . En…"
position: 2
---
...
![Flujo de delegación del proxy Diamond](/img/diamondSchema2.png)
...
![Delegación de facetas](/img/delegation.png)
...
![Componentes de facetas del Diamond](/img/diamondFacet2.png)

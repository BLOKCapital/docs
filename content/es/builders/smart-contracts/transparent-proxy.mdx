...
description: 'La implementación de Transparent Proxy sigue EIP-1967, que estandariza cómo los proxys almacenan la dirección del contrato de implementación.'
position: 4
---

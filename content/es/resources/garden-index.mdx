...
description: Un índice ponderado por capitalización de mercado asigna pesos a los activos en proporción a su capitalización de mercado relativa al total de la capitalización de mercado del portafolio (o cesta).
position: 5
---
...
![Fórmula de ponderación por capitalización de mercado](/img/mcapformula.png)
...
![Ponderación del índice del Garden](/img/GardenIndex.png)
...
<Admonition kind="warning" title="Esta arquitectura aún está en desarrollo y será introducida en una futura versión. La información aquí provista es preliminar y puede cambiar sin previo aviso.">

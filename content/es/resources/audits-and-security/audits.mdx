...
description: 'En BLOK Capital, la seguridad no es solo una característica, es nuestra base. Estamos comprometidos a garantizar que nuestros smart contracts sean lo más seguros, confiables y resilientes posible.'
position: 1
---
Para lograrlo, nuestros contratos son auditados de forma independiente, y lo ampliamos con un programa de recompensas de bugs en Immunefi y concursos de auditoría en Cantina y Code4rena.

## Auditorías completadas

El protocolo BLOK Capital ha sido auditado por [CredShields](https://credshields.com/), y la capa de abstracción de cuentas sobre la que se construye — la smart wallet Kernel de ZeroDev — cuenta con sus propias auditorías independientes. Todos los informes se publican íntegramente a continuación; todos los problemas reportados han sido resueltos.

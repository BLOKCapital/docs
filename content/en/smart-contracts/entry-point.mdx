...
description: "Entry Point: The Diamond Controller ( ) File: This is the main controller contract and the only contract address that end‑users and most integrations…"
position: 2
---

...
description: 'Key files in the facet registry: FacetRegistry.sol manages facet registration and version tracking; IFacetRegistry.sol is the public interface.'
position: 4
---

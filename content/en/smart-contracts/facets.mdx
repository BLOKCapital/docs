...
description: "Facet Architecture (Grouped by Responsibility) The facets are split into two main groups: 1. Base facets – the core of the Diamond. 2. Feature facets –…"
position: 3
---

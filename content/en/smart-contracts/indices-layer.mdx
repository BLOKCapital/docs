---
title: Indices Layer
description: "Indices Layer (Domain & Business Logic) Location: Key components: - : Core index contract managing components and weights. - : Factory for deploying Index…"
position: 5
---

---
title: Indices Layer
description: 'Key components: Core index contract managing components and weights. Factory for deploying Index instances. Whitelist of approved tokens. Whitelist of approved calculation strategies.'
position: 5
---

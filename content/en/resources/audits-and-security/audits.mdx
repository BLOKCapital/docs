...
description: 'At BLOK Capital, security isn’t just a feature, it’s our foundation. We are committed to ensuring that our smart contracts are as secure, reliable, and resilient as possible.'
position: 1
---
To achieve this, our contracts are independently audited, and we are extending that with a bug bounty program on Immunefi and audit contests on Cantina and Code4rena.

## Completed audits

The BLOK Capital protocol has been audited by [CredShields](https://credshields.com/), and the account-abstraction layer it builds on — ZeroDev's Kernel smart wallet — carries its own independent audits. Every report is published in full below; all reported issues have been resolved.

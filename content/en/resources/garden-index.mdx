...
description: A market-cap weighted index assigns weights to assets proportional to their market capitalization relative to the total market capitalization of the portfolio (or basket).
position: 5
---
...
![Market-cap weighting formula](/img/mcapformula.png)
...
![Garden index weighting](/img/GardenIndex.png)
...
<Admonition kind="warning" title="This architecture is still under development and will be introduced in a future release. The information provided here is preliminary and may change without notice.">

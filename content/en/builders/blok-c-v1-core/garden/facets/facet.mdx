---
title: Facet.sol
description: "Access Layer: - acts as the base contract for all logic modules in the Garden. - It defines the core access control rules that every module follows. - Its…"
position: 1
---

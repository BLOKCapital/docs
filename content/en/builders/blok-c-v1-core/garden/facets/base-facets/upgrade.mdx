---
title: Upgrade
description: 'As is blocked in the Base Facets, the Upgrade Module is the only authorized way to alter a Garden''s logic. It relies on a deterministic, version-controlled sync with the global .'
position: 4
---

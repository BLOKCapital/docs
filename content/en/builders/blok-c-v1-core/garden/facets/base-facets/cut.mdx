---
title: Cut
description: "This module manages state upgrades within the Diamond but enforces Blok Capital's strict \"Registry-First\" security model. This is the internal engine for…"
position: 1
---

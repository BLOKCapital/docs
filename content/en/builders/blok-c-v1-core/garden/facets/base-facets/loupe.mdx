---
title: Loupe
description: The Loupe module is entirely read-only.
position: 2
---
It provides the introspection functions required by EIP-2535, allowing block explorers, frontends, and indexing bots to "see" inside the Garden and map out its capabilities.

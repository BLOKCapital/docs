---
title: IIndex.sol
description: This interface defines the essential data structures passed between the off-chain Centralized Relayer Engine (CRE) and the on-chain protocol.
position: 2
---

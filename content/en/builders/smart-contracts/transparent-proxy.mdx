---
title: Why Transparent proxy standard for Factory and Registries?
description: "ERC-1967: Preventing Storage Collisions The Transparent Proxy implementation follows EIP-1967, which standardizes how proxies store the implementation…"
position: 4
---

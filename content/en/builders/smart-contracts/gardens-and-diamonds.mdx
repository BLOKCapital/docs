---
title: Gardens & Diamonds
description: "The Architecture of Diamonds & Gardens At BLOK Capital, our main architecture for the smart contracts depends on the Diamond proxy pattern. In this…"
position: 2
---
...
### Proxy Contract Flow: 
![Diamond proxy delegation flow](/img/diamondSchema2.png)
...
![Facet delegation](/img/delegation.png)
...
![Diamond facet components](/img/diamondFacet2.png)

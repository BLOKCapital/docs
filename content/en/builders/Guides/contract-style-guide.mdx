---
title: Smart contract style guide
description: 'Our protocol uses a modular diamond/facet architecture, where each facet encapsulates a specific domain (e.g., Uniswap swaps, garden creation, access control).'
---
## Naming conventions
...
Follow the official solidity guide for more : [official Solidity style guide](https://docs.soliditylang.org/en/latest/style-guide.html#order-of-layout)

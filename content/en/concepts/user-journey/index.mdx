---
title: User Journey
description: Sign in with Google. Create your smart wallet account (SWA). This is the account that will hold your assets and interact with the protocol.
position: 2
---
![User journey flow](/img/Userflow.png)
...
The sections above describe the journey in order. The pages below break each part into the actual steps in the application, including what happens when something fails.

- [Signing In and the Dashboard](/en/concepts/user-journey/signing-in) covers both login methods, what the dashboard loads, and how sessions end.
- [Creating and Funding Gardens](/en/concepts/user-journey/gardens) covers creating a yield or index garden, the garden details screen, and moving assets in.
- [Trading and Lending](/en/concepts/user-journey/trading-and-lending) covers swaps, lending, and withdrawing USDC.
- [Index Gardens](/en/concepts/user-journey/index-gardens) covers browsing indexes, connecting, rebalancing, and disconnecting.
- [Performance, Governance and Settings](/en/concepts/user-journey/performance-and-governance) covers performance charts, voting, and the account section.
- [Transaction States](/en/concepts/user-journey/transaction-states) covers the status sequence every on-chain action shares.

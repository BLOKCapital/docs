...
description: "Proxy Contracts Explained A proxy contract is a way to upgrade a smart contract system without changing the address users interact with. Instead of…"
position: 2
---
![Proxy contract pattern](/img/Frame%2025.jpg)

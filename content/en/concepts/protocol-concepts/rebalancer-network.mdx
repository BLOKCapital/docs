...
description: "The Rebalancer is a single smart contract designed for highly efficient, gas-minimized index and yield management. It treats the protocol's total liquidity as one pooled amount and moves it together…"
position: 7
---

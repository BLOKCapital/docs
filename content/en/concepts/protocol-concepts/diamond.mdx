---
title: Diamond
description: "Diamond Architecture Overview The Diamond architecture is a modular smart contract system designed for long-lived, evolving protocols. At its core, a…"
position: 1
---
## Diamond Architecture Overview

![Diamond proxy architecture](/img/Diamond_proxy.png)

...
description: "How does Blok Capital manages the atomic asynchronous transaction? 1). Contract Layer (Signal Emission): - Here the contracts which are deployed mainly do…"
position: 5
---
### How does Blok Capital manages the atomic asynchronous transaction?

![Decentralised oracle network](/img/Frame-22.jpg)

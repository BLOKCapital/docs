...
description: 'Account Abstraction replaces the limitations of traditional Ethereum wallets with programmable smart contract wallets that control how transactions are authorized, executed, and paid for.'
position: 3
---
![Account abstraction](/img/Frame-27.png)

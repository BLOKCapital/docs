...
description: 'Chez BLOK Capital, la sécurité n''est pas seulement une fonctionnalité, c''est notre fondation.'
position: 1
---
Nous nous engageons à garantir que nos smart contracts soient aussi sûrs, fiables et résilients que possible. Pour cela, nos contrats sont audités de manière indépendante, et nous complétons cela par un programme de bug bounty sur Immunefi et des concours d'audit sur Cantina et Code4rena.

## Audits réalisés

Le protocole BLOK Capital a été audité par [CredShields](https://credshields.com/), et la couche d'abstraction de compte sur laquelle il repose — le smart wallet Kernel de ZeroDev — dispose de ses propres audits indépendants. Tous les rapports sont publiés intégralement ci-dessous ; tous les problèmes signalés ont été résolus.

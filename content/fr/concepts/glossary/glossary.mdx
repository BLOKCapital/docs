---
title: Glossaire
description: Architecture Centrale (Patron Diamond / EIP-2535) · Garden et Factory · Indice et Reequilibrage · Gouvernance et Statut du Protocole · DEX et Liquidite
position: 1
---
...
| Rebalance Interval (Intervalle de Reequilibrage) | Temps minimum (24 heures) entre les reequilibrages consecutifs. |
| Intent Interval (Intervalle d'Intention) | Temps minimum (11 minutes) entre deux creations d'intention de reequilibrage. Maintenu superieur a l'expiration de 10 minutes afin qu'une intention vivante ne puisse pas etre ecrasee. |
| Swap Call (Appel d'Echange) | Instruction individuelle d'echange fournie par l'appelant, contenant le selecteur, les donnees encodees, le token de sortie, la sortie minimale et un deadline. |

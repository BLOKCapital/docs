...
description: "Explication des Contrats Proxy Un contrat proxy est un moyen de mettre à jour un système de contrats intelligents sans changer l'adresse avec laquelle les…"
position: 2
---
![Modèle de contrat proxy](/img/Frame%2025.jpg)

...
description: Un contrat proxy est un moyen de mettre à jour un système de contrats intelligents sans changer l'adresse avec laquelle les utilisateurs interagissent.
position: 2
---

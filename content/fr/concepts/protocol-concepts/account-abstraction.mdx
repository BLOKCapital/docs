...
description: L'Abstraction de Compte remplace les limitations des portefeuilles Ethereum traditionnels par des portefeuilles de contrats intelligents programmables qui contrôlent la manière dont les transactions…
position: 3
---
![Abstraction de comptes](/img/Frame-27.png)

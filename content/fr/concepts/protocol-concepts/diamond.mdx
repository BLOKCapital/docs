---
title: Diamond
description: "Aperçu de l'Architecture Diamond L'architecture Diamond est un système de contrats intelligents modulaire conçu pour des protocoles à longue durée de vie…"
position: 1
---
## Aperçu de l'Architecture Diamond

![Architecture du proxy Diamond](/img/Diamond_proxy.png)

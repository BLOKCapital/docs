---
title: Diamond
description: L'architecture Diamond est un système de contrats intelligents modulaire conçu pour des protocoles à longue durée de vie et en constante évolution.
position: 1
---

...
description: 'Notre protocole utilise une architecture modulaire diamant/facette, où chaque facette encapsule un domaine spécifique (par ex. swaps Uniswap, création de « gardens », contrôle d’accès).'
---
...
Consultez la guide officiel de Solidity pour plus de détails : [guide de style officiel de Solidity](https://docs.soliditylang.org/en/latest/style-guide.html#order-of-layout)

---
title: Gouvernance avec Aragon
description: 'Chez BLOKC, nous redéfinissons la gouvernance décentralisée en construisant un système de propositions DAO robuste et modulaire, alimenté de manière transparente par Aragon OSX.'
position: 2
---
En tirant parti du cadre de pointe d'Aragon, nous donnons à notre communauté un processus de gouvernance transparent, évolutif et, surtout, axé sur la communauté. Il ne s'agit pas seulement de technologie ; il s'agit de créer un avenir où chaque voix de l'écosystème BLOKC compte.
...
![Architecture des propositions de la DAO BLOK Capital](/img/daoProposal2.png)
...
- [Découvrez la vision de BLOK Capital](https://blokcapital.io/)
- [En savoir plus sur Aragon](https://docs.aragon.org/)

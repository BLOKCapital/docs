---
title: Facet.sol
description: agit comme le contrat de base pour tous les modules de logique du Garden. Il définit les règles de contrôle d'accès centrales que chaque module suit.
position: 1
---

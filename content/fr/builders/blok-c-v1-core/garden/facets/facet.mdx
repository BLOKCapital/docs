---
title: Facet.sol
description: "Couche d'Accès : - agit comme le contrat de base pour tous les modules de logique du Garden. - Il définit les règles de contrôle d'accès centrales que…"
position: 1
---

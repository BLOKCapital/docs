...
description: Ces fichiers contiennent la logique métier principale pour le rééquilibrage de portefeuille. Le processus est divisé en deux transactions distinctes pour garantir la sécurité.
position: 3
---
...
2. **`_rebalance(SwapStep[])` :** Exécute les transactions réelles selon les instructions fournies par l'appelant.

---
title: IIndex.sol
description: Cette interface définit les structures de données essentielles échangées entre le Centralized Relayer Engine (CRE) off-chain et le protocole on-chain.
position: 2
---

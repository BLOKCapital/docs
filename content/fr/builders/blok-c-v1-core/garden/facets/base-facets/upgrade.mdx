---
title: Upgrade
description: 'Comme est bloqué dans les Base Facets, le Module Upgrade est le seul moyen autorisé de modifier la logique d''un Garden. Il repose sur une synchronisation déterministe et versionnée avec le global.'
position: 4
---

---
title: Ownership
description: 'Le module de propriété (ownership) fournit le contrôle administratif standard ERC-173, mais stocke l''état de manière sécurisée dans le modèle Diamond Storage pour éviter les collisions lors des mises à jour.'
position: 3
---

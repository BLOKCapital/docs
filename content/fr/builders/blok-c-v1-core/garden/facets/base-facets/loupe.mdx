---
title: Loupe
description: "Le module Loupe est entièrement en lecture seule. Il fournit les fonctions d'introspection requises par l'EIP-2535, permettant aux explorateurs de blocs,…"
position: 2
---

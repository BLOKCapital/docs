...
description: 'L’implémentation du Transparent Proxy suit EIP-1967, qui standardise la manière dont les proxys stockent l’adresse du contrat d’implémentation.'
position: 4
---

...
description: 'Composants clés: Contrat d''indice central gérant les composants et les poids. Usine pour le déploiement d''instances d''Index. Liste blanche des jetons approuvés.'
position: 5
---

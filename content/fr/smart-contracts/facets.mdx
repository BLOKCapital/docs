...
description: "Architecture des Facettes (Groupées par Responsabilité) Les facettes sont divisées en deux groupes principaux : 1. Facettes de base – le cœur du Diamond.…"
position: 3
---

...
description: 'Fichiers clés du registre de facettes : FacetRegistry.sol gère l''enregistrement des facettes et le suivi des versions ; IFacetRegistry.sol est l''interface publique.'
position: 4
---

...
description: "Aperçu du Système Ce dépôt implémente un protocole de gestion d'actifs on-chain construit autour d'un contrôleur Diamond (EIP-2535) appelé le Garden .…"
position: 1
---
![Vue d'ensemble du système](/img/Frame%2021.jpg)

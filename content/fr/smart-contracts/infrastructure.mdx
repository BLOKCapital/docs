...
description: 'La puissance de Diamond s''accompagne d''une contrainte majeure : toutes les facettes partagent le même stockage. Pour gérer cela en toute sécurité, ce dépôt utilise des bibliothèques de stockage.'
position: 6
---
